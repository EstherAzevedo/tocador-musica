...
let repeatOn = false;
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [a_thousand_years_christina_perri, photograph_ed_sheeran, photograph_ed_sheeran, happy_birthday];
